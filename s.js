            ...
            zoneNames.forEach((zoneName, ind)=>{
                if (yearsAssessed[ind] == 2023) {
                    ...
                    const popupContent = `
                        ...
                        <strong>Build Year:</strong> ${yearsBuilt[ind]}<br>
                        <strong>Current Zone's Average Assessed Value: </strong> $ ${zoningData[zoneName].totalValue/zoningData[zoneName].count}
                    `;
